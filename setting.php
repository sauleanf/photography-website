...
<html>
  ...
  <body>
    <div class="full-window">
      <form enctype="application/x-www-form-urlencoded" method="post" class="form-box">
      ...
      if(isset($_SESSION['username'])) {
          ...
          if($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if($_POST['password1'] === $_POST['password2'] && $_POST['username'] === "") {
              ...
              $update = "UPDATE users_table SET password='$password_hashed' WHERE username='$session_username'";
